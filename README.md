...
> **Roadmap и кураторская подборка ресурсов по Ruby on Rails на русском.** От языка Ruby
> и основ Rails — до тестов, Hotwire, деплоя через Kamal и разработки с ИИ. Путь от
> новичка до уверенного backend-разработчика по принципу «документация → практика».

[![Awesome](https://awesome.re/badge-flat2.svg)](https://github.com/sindresorhus/awesome)
[![License: CC0-1.0](https://img.shields.io/badge/License-CC0_1.0-lightgrey.svg)](LICENSE)
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)](CONTRIBUTING.md)
![Last commit](https://img.shields.io/github/last-commit/yurik2718/rails-roadmap-ru)
[![Stars](https://img.shields.io/github/stars/yurik2718/rails-roadmap-ru?style=social)](https://github.com/yurik2718/rails-roadmap-ru/stargazers)
...
- [🥋 Уровень 1. Падаван — фундамент](#-уровень-1-падаван--фундамент)
  — [Ruby](#сам-язык-ruby-до-rails) · [Rails](#ruby-on-rails) · [Стиль кода](#стиль-кода) · [Веб](#веб-фронтенд-основы) · [Базы данных](#базы-данных) · [Git](#git) · [Docker](#docker)
- [🥋 Уровень 2. Сенсэй — боевой Rails](#-уровень-2-сенсэй--боевой-rails)
  — [Тесты](#тестирование) · [Фоновые задачи](#фоновые-задачи) · [Производительность](#производительность) · [Hotwire](#hotwire--фронтенд-без-spa) · [API](#api-и-интеграции) · [Безопасность](#безопасность) · [Деплой и CI/CD](#деплой-и-cicd) · [Микросервисы](#микросервисы-и-обмен-сообщениями)
- [🚀 Уровень 3. IndieHacker / MVP](#-уровень-3-indiehacker--mvp)
  — [Гибридный фронтенд](#гибридный-фронтенд-рецепты-evil-martians) · [Гемы](#гемы-которые-стоит-знать)
- [🤖 Разработка с ИИ](#-разработка-с-ии)
  — [Агенты в терминале](#агенты-в-терминале) · [Локальные модели](#открытые-и-локальные-модели) · [Rails + ИИ: рецепты](#rails--ии-рецепты)
- [📚 Справочник](#-справочник)
  — [Книги](#книги) · [Видео](#видео) · [Сообщества](#сообщества) · [Статьи](#статьи) · [Алгоритмы](#алгоритмы) · [Практика](#практика-кодом-каждый-день) · [Тренажёры](#тренажёры-продуктивности) · [Проектирование](#проектирование-и-документация)
- [🎓 Курсы — если совсем с нуля](#-курсы--если-совсем-с-нуля)
...
Нашёл классный ресурс или заметил, что ссылка протухла? Это коллективная подборка — присылай.

1. Загляни в [CONTRIBUTING.md](CONTRIBUTING.md) — там пара простых правил.
2. Открой [issue](https://github.com/yurik2718/rails-roadmap-ru/issues) или сразу [pull request](https://github.com/yurik2718/rails-roadmap-ru/pulls).

Каждая ссылка должна оправдывать своё место: либо первоисточник, либо лучший материал в своей теме.

## ⭐ Поддержать

Если подборка помогла — [поставь звезду](https://github.com/yurik2718/rails-roadmap-ru/stargazers). Это помогает другим найти её через поиск.

## 📄 Лицензия

[![CC0 1.0](https://img.shields.io/badge/License-CC0_1.0-lightgrey.svg)](LICENSE)

Распространяется под [CC0 1.0 Universal](LICENSE) — public domain. Бери, копируй, переделывай без ограничений.
